...
import { getMovie, updateFavoriteMovies } from '../../../../service';
...
export function MovieDetail() {
    ...
    useEffect(() => {
        ...
        else if (!isfavorite && user.favoriteMovies.includes(currentParams.id)) {
            ...
            <div className="movie-detail-aside">
                ...
                <div className="icons">
                    ...
                    <Tooltip title={isfavorite ? "Remove Favorite" : "Add Favorite"}>
                        <Button danger type='primary' ghost={isfavorite} shape="circle" icon={<HeartFilled />} onClick={() => setFavorite(!isfavorite)} />
                    </Tooltip>
                </div>
